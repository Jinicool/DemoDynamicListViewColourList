package sg.edu.rp.c346.id20022543.demodynamiclistviewcolourlist;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayAdapter<String> aaColour; //declares as an array adapter of string
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aaColour = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,alColours); //traffic controller link to the data
        lvColour.setAdapter(aaColour); //UI connected to traffic controller
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alColours.add(pos,newColour); //everytime we adding to the arraylist need to notify the traffic controller
